"""
Script file for training linear locally-symplectic neural networks 
...
for L in [4]:
    ...
    for m in [d]:
        ...
        for k in range(3):
            ...
            plt.savefig('Figures/AdvectionEq/LossAcc/LossAcc_L' + str(L) +
                        'm' + str(m) + 'k' + str(k) + '.png', 
            ...
            if sch:
                file_w = g + "schAdvectionEqD35N60M20Tau001Epoch20TH" + f
            else:
