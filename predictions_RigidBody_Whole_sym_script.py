...
for L in [2]:
    ...
    for m in [32, 64]:  
        ...
        for k in range(2):
            ...
            plt.savefig('Figures/RigidBody/Whole/Predictions/SymLocSympNets/' + 
        ...
        # optional: save figure
        plt.savefig('Figures/RigidBody/Whole/Predictions/SymLocSympNets/sym_SErr_L' + 
        ...
        ax.set_title('SymLocSympNets, Rigid Body: L=' + str(L) + ', m='+str(m))
        # optional: save figure
        plt.savefig('Figures/RigidBody/Whole/Predictions/SymLocSympNets/sym_HErr_L' + 
                    str(L) + 'm' + str(m) + '.png', dpi=300, bbox_inches='tight')
        plt.show()
        ...
        ax.set_title('SymLocSympNets, Rigid Body: L=' + str(L) + ', m='+str(m))
        # optional: save figure
        plt.savefig('Figures/RigidBody/Whole/Predictions/SymLocSympNets/sym_IErr_L' + 
                    str(L) + 'm' + str(m) + '.png', dpi=300, bbox_inches='tight')
        plt.show()
