...
for L in [2]:
    ...
    for m in [32, 64]:
        ...
        for k in range(2):
            ...
            file_w = g + "sym_schChargedParticleN200M100Tau02Epoch1000TH" + f
            ...
            ax.plot(U[:, 0], U[:, 1], ls='--', color='tab:cyan', linewidth='1', 
            ...
            ax.set_title('SymLocSympNets, Charged Particle: L=' + str(L) + 
                         ', m=' + str(m) + ', k=' + str(k), fontsize=20, loc='right')
            # optional: save figure
            plt.savefig('Figures/ChargedParticle/Predictions/SymLocSympNets/' +
        ...
        ax.grid(True)
        ax.set_title('SymLocSympNets, Charged Particle: L=' + str(L) + ', m='+str(m))
        # optional: save figure
        plt.savefig('Figures/ChargedParticle/Predictions/SymLocSympNets/sym_SErr_L' + 
        ...
        ax.set_title('SymLocSympNets, Charged Particle: L=' + str(L) + ', m='+str(m))
        # optional: save figure
        plt.savefig('Figures/ChargedParticle/Predictions/SymLocSympNets/sym_HErr_L' + 
                    str(L) + 'm' + str(m) + '.png', dpi=300, bbox_inches='tight')
        plt.show()
