...
with symmetric linear locally-symplectic neural networks 
"""
import numpy as np
import torch
...
for L in [2]:
    ...
    for m in [d]: 
        ...
        for k in range(3):
            ...
            ax.plot(x, np.append(U[-1, :], U[-1, 0]), ls='--', color='tab:green', 
            ...
            plt.savefig('Figures/AdvectionEq/Predictions/sym_Predictions_L' + 
